    ...
    return (
        ...
        <div className="stats-grid">
            <StatCard lg title="Active Caffeine Level">
                <div className="status">
                    ...
                    <h5 style={{color: statusLevels[warningLevel].color, background: 
                        statusLevels[warningLevel].background}}>{warningLevel}</h5>
                </div>
            ...
            <StatCard title="Daily Cost">
                <p>CHF <span className="stat-text">{stats.daily_cost}</span></p>
            </StatCard>
            <StatCard title="Total Cost">
                <p>CHF <span className="stat-text">{stats.total_cost}</span></p>
            </StatCard>
